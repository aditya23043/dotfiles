vim.api.nvim_create_autocmd("ColorScheme", {
  callback = function()
    ...
    elseif vim.g.colors_name == "gruvbox-material" and vim.o.background == "dark" then
      ...
      vim.api.nvim_set_hl(0, "Statusline", { fg = "#ddc7a1", bg = "#181a1b" })
    ...
    elseif vim.g.colors_name == "gruvbox" and vim.o.background == "dark" then
      vim.api.nvim_set_hl(0, "Normal", {bg = "#282828", fg = "#ddc7a1"})
    end
  end,
})
