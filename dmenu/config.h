...
static const char *fonts[] = {
    "JetBrainsMono NFM:style=Bold:size=12:antialias=true:autohint=true"};
// "Cascadia Code NF:style=ExtraBold:size=24:antialias=true:autohint=true"};
// "Fira Mono:style=Medium:size=10:antialias=true:autohint=true"};
